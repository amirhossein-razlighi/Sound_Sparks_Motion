...
| gen_firecracker | The firecracker explodes with a bang and a puff of smoke. | 8 (alt: 7) | user (09-09 11:50): iters 7 and 8 are good. iter 8 primary (fireball + dense smoke cloud at frame ~25, critic 0.30), iter 7 alternate (flash + puff at the same moment, critic 0.43). Baseline = the source's small puff, no bang. Critic best was iter 9 (0.70). |
...
| gen_glass_edge | The glass falls off the table and shatters on the floor. | 3 (alt: 8) | iter 3: the glass tips off the edge (frame ~70) and visibly shatters into fragments on the floor; baseline makes the glass vanish with a few drops. iter 8 candidate: shatters earlier (frame ~25) but with duplicated-glass artifacts; iters 5/7 drift (a person's legs appear). |
